...
static int sdi_db_sem_get(void)
{
    key_t sem_key;
...
static void sdi_db_sem_take(void)
{
    struct sembuf sb[1];
...
static void sdi_db_sem_give(void)
{
    struct sembuf sb[1];
 ...
 * @return None
 */
static void sdi_db_construct_path(char *buffer, const char *file)
{
